...
describe('WSSecurityCert', function() {
  ...
  describe('Signature validation', function() {
    ...
    var instance = new WSSecurityCert(key, cert, '', 'utf8');
    var xml = instance.postProcess('<soap:Header></soap:Header><soap:Body ID="_0"></soap:Body>');

    it('should validate a proper signature', function() {
      var res = instance.validateSignature(xml);
      res.should.be.true();
    });
  });
